  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4">
      ...
      <div className="prose dark:prose-invert max-w-none space-y-4 text-gray-700 dark:text-gray-300">
        ...
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-6">Information We Collect</h2>
        ...
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-6">How We Use Your Information</h2>
        <p>Your data is used to provide tuning services, process payments, communicate about jobs, and improve our platform.</p>
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-6">Data Security</h2>
        ...
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-6">Data Retention</h2>
        ...
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-6">Contact</h2>
