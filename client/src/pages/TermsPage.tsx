...
export default function TermsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4">
      <Link to="/" className="inline-flex items-center gap-1 text-primary-600 hover:underline mb-6 text-sm">
      ...
      <div className="prose dark:prose-invert max-w-none space-y-4 text-gray-700 dark:text-gray-300">
        ...
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-6">1. Service Description</h2>
        ...
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-6">2. Credits System</h2>
        ...
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-6">3. User Responsibilities</h2>
        ...
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-6">4. File Handling</h2>
        <p>Uploaded files are stored securely and processed by our team. We do not share your files with third parties.</p>
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-6">5. Revisions</h2>
        ...
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-6">6. Limitation of Liability</h2>
