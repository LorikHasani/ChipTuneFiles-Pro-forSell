                ...
                {users.map((u: any) => (
                  <tr key={u.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/30">
                    <td className="px-4 py-3">
                      <Link to={`/admin/users/${u.id}`} className="text-primary-600 hover:underline font-medium">
                        {u.contactName || '-'}
                      </Link>
                    </td>
                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400">{u.email}</td>
                    <td className="px-4 py-3 text-gray-600 dark:text-gray-400">{u.companyName || '-'}</td>
                    <td className="px-4 py-3">
                      <span className={cn('text-xs font-medium px-2 py-0.5 rounded',
                        ...
                        'bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300')}>{u.role}</span>
                    </td>
