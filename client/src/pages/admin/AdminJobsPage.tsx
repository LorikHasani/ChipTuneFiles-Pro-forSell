                ...
                {jobs.map((job: Job) => (
                  <tr key={job.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/30">
                    <td className="px-4 py-3">
                      <Link to={`/admin/jobs/${job.id}`} className="text-primary-600 hover:underline font-medium">
                        {job.referenceNumber}
                      </Link>
                    </td>
                    ...
                    <td className="px-4 py-3">
                      <span className="text-xs font-medium px-2 py-0.5 rounded bg-gray-100 dark:bg-gray-700">{job.jobType}</span>
                    </td>
