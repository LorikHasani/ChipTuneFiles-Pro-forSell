  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4">
      ...
      <div className="prose dark:prose-invert max-w-none space-y-4 text-gray-700 dark:text-gray-300">
        ...
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-6">Credit Purchases</h2>
        ...
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-6">Job Refunds</h2>
        ...
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-6">Revision Policy</h2>
        ...
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mt-6">How to Request a Refund</h2>
